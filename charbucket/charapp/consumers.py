...
class QuickConsumer(AsyncJsonWebsocketConsumer):
    async def connect(self):
        self.room_name = self.scope['url_route']['kwargs']['room_key']
        self.room_group_name = 'quickroom_%s' % self.room_name
    ...
    async def receive(self, text_data):
        text_data_json = json.loads(text_data)
        if text_data_json['llama'] == 'qComment':
            data = {
                'llama': 'qComment',
                'comment': text_data_json['commText'],
                'userID': text_data_json['userID']
        ...
        elif text_data_json['llama'] == 'qAlteration':
            data = {
                'llama': 'qAlteration',
                'userID': text_data_json['userID'],
                'message': text_data_json['whiteboard'],
